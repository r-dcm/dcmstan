...
---
    ...
    Output
      ...
      transformed parameters {
        ...
        pi[15,16] = inv_logit(l1_0+l1_1+l4_0+l4_1);
        ...
        pi[19,16] = inv_logit(l1_0+l1_1+l2_0+l2_1);
        ...
        pi[27,16] = inv_logit(l1_0+l1_1+l2_0+l2_1);
      }
      model {
