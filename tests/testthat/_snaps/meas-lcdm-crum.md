...
# lcdm with hierarchy works
    ...
    Output
      ...
      parameters {
        ...
        real<lower=-1 * min([l8_12,l8_13])> l8_223;
        real<lower=-1 * min([l10_11+l10_212+l10_213,l10_12+l10_212+l10_223,l10_13+l10_213+l10_223])> l10_3123;
        real<lower=-1 * min([l11_11+l11_212+l11_213,l11_12+l11_212+l11_223,l11_13+l11_213+l11_223])> l11_3123;
        real<lower=-1 * min([l12_11+l12_212+l12_213,l12_12+l12_212+l12_223,l12_13+l12_213+l12_223])> l12_3123;
        real<lower=-1 * min([l13_11+l13_212+l13_213,l13_12+l13_212+l13_223,l13_13+l13_213+l13_223])> l13_3123;
        real<lower=-1 * min([l14_11+l14_212+l14_213,l14_12+l14_212+l14_223,l14_13+l14_213+l14_223])> l14_3123;
        real<lower=-1 * min([l16_11+l16_212+l16_213,l16_12+l16_212+l16_223,l16_13+l16_213+l16_223])> l16_3123;
        real<lower=-1 * min([l17_12,l17_13])> l17_223;
        real<lower=-1 * min([l20_11+l20_212+l20_213,l20_12+l20_212+l20_223,l20_13+l20_213+l20_223])> l20_3123;
        real<lower=-1 * min([l21_11+l21_212+l21_213,l21_12+l21_212+l21_223,l21_13+l21_213+l21_223])> l21_3123;
        real<lower=-1 * min([l23_12,l23_13])> l23_223;
        real<lower=-1 * min([l24_12,l24_13])> l24_223;
        real<lower=-1 * min([l25_11+l25_212+l25_213,l25_12+l25_212+l25_223,l25_13+l25_213+l25_223])> l25_3123;
        real<lower=-1 * min([l27_11+l27_212+l27_213,l27_12+l27_212+l27_223,l27_13+l27_213+l27_223])> l27_3123;
      }
      transformed parameters {
        vector[C] log_Vc = log(Vc);
        matrix[I,C] pi;
        ...
        pi[2,5] = inv_logit(l2_0);
        pi[2,6] = inv_logit(l2_0);
        pi[2,7] = inv_logit(l2_0+l2_223);
        pi[2,8] = inv_logit(l2_0+l2_223);
        pi[3,1] = inv_logit(l3_0);
        pi[3,2] = inv_logit(l3_0);
        pi[3,3] = inv_logit(l3_0);
        pi[3,4] = inv_logit(l3_0+l3_13);
        ...
        pi[8,5] = inv_logit(l8_0);
        pi[8,6] = inv_logit(l8_0);
        pi[8,7] = inv_logit(l8_0+l8_223);
        pi[8,8] = inv_logit(l8_0+l8_223);
        pi[9,1] = inv_logit(l9_0);
        pi[9,2] = inv_logit(l9_0);
        pi[9,3] = inv_logit(l9_0);
        pi[9,4] = inv_logit(l9_0+l9_13);
        ...
        pi[10,6] = inv_logit(l10_0);
        pi[10,7] = inv_logit(l10_0);
        pi[10,8] = inv_logit(l10_0+l10_3123);
        pi[11,1] = inv_logit(l11_0);
        pi[11,2] = inv_logit(l11_0);
        pi[11,3] = inv_logit(l11_0);
        pi[11,4] = inv_logit(l11_0+l11_13);
        ...
        pi[13,6] = inv_logit(l13_0);
        pi[13,7] = inv_logit(l13_0);
        pi[13,8] = inv_logit(l13_0+l13_3123);
        pi[14,1] = inv_logit(l14_0);
        ...
        pi[14,7] = inv_logit(l14_0);
        pi[14,8] = inv_logit(l14_0+l14_3123);
        pi[15,1] = inv_logit(l15_0);
        pi[15,2] = inv_logit(l15_0);
        pi[15,3] = inv_logit(l15_0);
        pi[15,4] = inv_logit(l15_0+l15_13);
        ...
        pi[23,5] = inv_logit(l23_0);
        pi[23,6] = inv_logit(l23_0);
        pi[23,7] = inv_logit(l23_0+l23_223);
        pi[23,8] = inv_logit(l23_0+l23_223);
        pi[24,1] = inv_logit(l24_0);
        pi[24,2] = inv_logit(l24_0);
        ...
        pi[24,5] = inv_logit(l24_0);
        pi[24,6] = inv_logit(l24_0);
        pi[24,7] = inv_logit(l24_0+l24_223);
        pi[24,8] = inv_logit(l24_0+l24_223);
        pi[25,1] = inv_logit(l25_0);
        pi[25,2] = inv_logit(l25_0);
        pi[25,3] = inv_logit(l25_0);
        pi[25,4] = inv_logit(l25_0);
        pi[25,5] = inv_logit(l25_0);
        pi[25,6] = inv_logit(l25_0);
        pi[25,7] = inv_logit(l25_0);
        pi[25,8] = inv_logit(l25_0+l25_3123);
        pi[26,1] = inv_logit(l26_0);
        pi[26,2] = inv_logit(l26_0);
        pi[26,3] = inv_logit(l26_0);
        pi[26,4] = inv_logit(l26_0+l26_13);
        ...
        pi[27,4] = inv_logit(l27_0);
        pi[27,5] = inv_logit(l27_0);
        pi[27,6] = inv_logit(l27_0);
        pi[27,7] = inv_logit(l27_0);
        pi[27,8] = inv_logit(l27_0+l27_3123);
        pi[28,1] = inv_logit(l28_0);
        pi[28,2] = inv_logit(l28_0);
        pi[28,3] = inv_logit(l28_0);
        pi[28,4] = inv_logit(l28_0+l28_13);
