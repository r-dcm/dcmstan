...
- x:
  ...
  model](https://dcmstan.r-dcm.org/reference/structural-model.md) or
  [model
...
model](https://dcmstan.r-dcm.org/reference/structural-model.md), a
vector of attribute names, as in the `qmatrix_meta$attribute_names` of a
[DCM specification](https://dcmstan.r-dcm.org/reference/dcm_specify.md).
