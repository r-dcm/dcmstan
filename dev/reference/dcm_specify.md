...
- measurement_model:
  ...
  A [measurement
  model](https://dcmstan.r-dcm.org/dev/reference/measurement-model.md)
  object.

- structural_model:

  A [structural
  model](https://dcmstan.r-dcm.org/dev/reference/structural-model.md)
  object.

- priors:

  A prior object created by
  [`prior()`](https://dcmstan.r-dcm.org/dev/reference/prior.md). If
  `NULL` (the default), default prior distributions defined by
