...
This outlines how to propose a change to dcmstan. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("r-dcm/dcmstan", fork = TRUE)`.
...
Code of Conduct](https://dcmstan.r-dcm.org/dev/CODE_OF_CONDUCT.md). By
