...
- Define [`prior()`](https://dcmstan.r-dcm.org/dev/reference/prior.md)
  distributions, and
...
[`dcm_specify()`](https://dcmstan.r-dcm.org/dev/reference/dcm_specify.md),
which requires a Q-matrix, the name of the item identifier column in the
Q-matrix (optional), and the choice of measurement and structural
models.
...
estimating the model with [rstan](https://mc-stan.org/rstan/) or
