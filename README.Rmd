...
* Generate Stan code for the model, given the specifications and priors with `generate_stan()`
...
Please note that the dcmdata project is released with a [Contributor Code of Conduct](https://dcmstan.r-dcm.org/CODE_OF_CONDUCT.html).
