...
[![R package version](https://www.r-pkg.org/badges/version/dcmstan)](https://cran.r-project.org/web/packages/dcmstan)
[![Package downloads](https://cranlogs.r-pkg.org/badges/grand-total/dcmstan)](https://cran.r-project.org/web/packages/dcmstan)</br>
...
You can install the released version of dcmstan from [CRAN](https://cran.r-project.org/) with:
