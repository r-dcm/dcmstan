...
S7::method(get_parameters, dcm_specification) <- function(
  x,
  qmatrix,
  identifier = NULL
) {
  if (lifecycle::is_present(qmatrix) || !is.null(identifier)) {
    ...
    cli::cli_warn(
      glue::glue(
        "{{.arg qmatrix}} and {{.arg identifier}} should not be
  ...
  if (is.null(x@qmatrix_meta$item_identifier)) {
    ...
    q_matrix <- x@qmatrix |>
      dplyr::mutate(
        !!x@qmatrix_meta$item_identifier := names(x@qmatrix_meta$item_names),
        .before = 1
      )
  }
...
S7::method(get_parameters, LCDM) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL,
...
S7::method(get_parameters, DINA) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL,
...
S7::method(get_parameters, DINO) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL,
...
S7::method(get_parameters, CRUM) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL,
...
S7::method(get_parameters, NIDA) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL,
...
S7::method(get_parameters, NIDO) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL,
...
S7::method(get_parameters, NCRUM) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL,
...
S7::method(get_parameters, UNCONSTRAINED) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL
...
S7::method(get_parameters, INDEPENDENT) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL
...
S7::method(get_parameters, LOGLINEAR) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL
...
S7::method(get_parameters, HDCM) <- function(
  x,
  qmatrix,
  identifier = NULL,
  attributes = NULL
